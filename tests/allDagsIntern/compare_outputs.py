...
for case in all_cases:
    ...
    if r_results[case]["gm"] != py_results[case]["gm"]:
        differences.append(f"Testcase {case}: gm mismatch")
        case_ok = False

    if r_results[case]["a"] != py_results[case]["a"]:
        differences.append(f"Testcase {case}: a mismatch")
        case_ok = False
